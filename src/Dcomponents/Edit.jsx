...
const Edit = () => {
  ...
  const [file, setFile] = useState(avatar3);
  ...
  return (
    <div className='flex justify-center items-start w-full p-5 bg-gray-100 mb-40'>
          ...
          <div className='lg:w-1/3 text-center mb-6'>
            ...
            <div className='flex justify-center items-center mt-2 relative'>
              <label className='flex items-center cursor-pointer'>
                ...
                <img src={file} alt="Profile" className='w-20 h-20 rounded-full object-cover border border-gray-300' />
              </label>
            </div>
            <p className='text-gray-700 text-lg mt-2'>Allowed *.jpeg, *.jpg, *.png, *.gif max size of 3 Mb</p>
            <button  className={`bg-rose-600 text-white font-bold py-2 px-4 rounded-lg '}`}>
                {'Delete User'}
              </button>
            <div className="mt-4">
            <p className='text-gray-700 text-lg mt-2'>Disabling this will automatically send the user a verification email</p>
